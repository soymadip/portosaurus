...
Codeberg Actions is a modern CI/CD system compatible with GitHub Actions. Portosaurus provides a ready-to-go workflow in `.forgejo/workflows/deploy.yml`.
...
```bash
bunx {{meta.pkg}} init-ci --hosting woodpecker
```
